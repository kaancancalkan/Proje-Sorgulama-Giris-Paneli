		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Proje Sorgulama Gİris Paneli",
									"targetURL": "#girispaneliprojesorgulama-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"girispaneliprojesorgulama-display": {
								"semanticObject": "girispaneliprojesorgulama",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=girispaneli.projesorgulama",
									"url": sap.ui.require.toUrl("girispaneli/projesorgulama")
								}
							}
						}
					}
